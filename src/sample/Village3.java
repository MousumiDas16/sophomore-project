...
public class Village3 extends Application {
    ...
    public Scene createScene(Stage x, Player hero) {
        ...
        Rectangle Bot_Rec = new Rectangle(AppSettings.screenWidth,
                AppSettings.bottomUIHeight);
        ...
        Image img = new Image("sample/Art/Background/Summerville.png", AppSettings.centerUIWidth,
            ...
            public void handle(ActionEvent event) {
                ...
                towntalk.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        Image img = new Image("sample/Art/Background/Summerville.png", 650, 400, true, true);
