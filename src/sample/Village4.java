...
public class Village4 extends Application {
    ...
    public Scene createScene(Stage x, Player hero) {
        ...
        Image img = new Image("sample/Art/Background/Geistadt_.png", AppSettings.centerUIWidth,
            ...
            public void handle(ActionEvent event) {
                ...
                towntalk.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        Image img = new Image("sample/Art/Background/Geistadt_.png", 650, 400, true, true);
